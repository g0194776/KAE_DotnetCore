...
namespace KJFramework.Messages.TypeProcessors
{
    ...
    public class Int16ArrayIntellectTypeProcessor : IntellectTypeProcessor
    {
        ...
        public unsafe override void Process(IMemorySegmentProxy proxy, object target, bool isArrayElement = false, bool isNullable = false)
        {
            ...
            if (array.Length > 10) fixed (short* pByte = array) proxy.WriteMemory(pByte, (uint)array.Length * Size.Int16);
            else for (int i = 0; i < array.Length; i++) proxy.WriteInt16(array[i]);
        }
