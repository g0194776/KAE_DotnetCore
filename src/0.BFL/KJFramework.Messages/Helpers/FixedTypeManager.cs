...
namespace KJFramework.Messages.Helpers
{
    ...
    public static class FixedTypeManager
    {
        ...
        static FixedTypeManager()
        {
            ...
            _vt.Add(typeof(IntPtr).FullName, new VT { Size = (int) Size.IntPtr });
            _vt.Add(typeof(Guid).FullName, new VT { Size = 16 });
            _vt.Add(typeof(BitFlag).FullName, new VT { Size = 1 });
            _vt.Add(typeof(IPEndPoint).FullName, new VT { Size = 8 });
