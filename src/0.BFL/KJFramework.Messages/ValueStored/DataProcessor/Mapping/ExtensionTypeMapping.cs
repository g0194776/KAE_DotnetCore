...
namespace KJFramework.Messages.ValueStored.DataProcessor.Mapping
{
    ...
    public static class ExtensionTypeMapping
    {
        ...
        public static void Regist(Type type)
        {
            ...
            if (valueStored == null) throw new ArgumentNullException(nameof(type));
            ...
            if (!(valueStored.Clone().GetType().GetTypeInfo().IsSubclassOf(typeof(BaseValueStored)))) throw new ArgumentException("#Generated instance of Clone method was not the sub class of BaseValueStored");
