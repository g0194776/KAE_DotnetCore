    ...
    internal unsafe sealed class MemorySegment : IMemorySegment
    {
        ...
        public void WriteString(string value)
        {
            ...
            fixed (byte* pByte = (strBytes = Encoding.UTF8.GetBytes(value)))
                Buffer.MemoryCopy(pByte, &_startData[_currentOffset], (_length - _currentOffset), strBytes.Length);
        ...
        public void WriteIPEndPoint(IPEndPoint value)
        {
            ...
            *(int*) (pByte) = BitConverter.ToInt32(addressBytes, 0);
        ...
        {
            Buffer.MemoryCopy((void*)value, (void*)new IntPtr(_startData + _currentOffset), (_length - _currentOffset), length);
