...
namespace KJFramework.Tracing
{
    internal class NullTracing : ITracing
    {
        ...
        public void DebugInfo(string format, ConsoleColor color = ConsoleColor.Gray, params object[] args) { Trace(TracingLevel.Debug, null, format, args, color); }
        ...
        protected virtual void Trace(TracingLevel level, System.Exception error, string format, object[] args, ConsoleColor color = ConsoleColor.Gray) { /* no-op */ }
