...
namespace KJFramework.Helpers
{
    ...
    public class TypeHelper
    {
        ...
        public static List<FieldWithAttribute<T>> GetFields<T>(Type type) where T : System.Attribute
        {
            ...
            var result = type.GetTypeInfo().GetFields().Where(field => AttributeHelper.GetCustomerAttribute<T>(field) != null);
        ...
        public static List<FieldWithName> GetFields(Type type)
        {
            ...
            return type.GetTypeInfo().GetFields().Select(field => new FieldWithName { FieldInfo = field, Name = field.Name }).ToList();
        }
        ...
        public static List<PropertyWithName> GetProperties(Type type)
        {
            ...
            return type.GetTypeInfo().GetProperties().Select(property => new PropertyWithName { PropertyInfo = property, Name = property.Name }).ToList();
        }
        ...
        public static MethodInfo[] GetMethods<T>(T target)
        {
            ...
            return target.GetType().GetTypeInfo().GetMethods();
        }
        ...
        public static MethodInfo GetMethods<T>(T target, String name)
        {
            ...
            try
            {
                return target.GetType().GetTypeInfo().GetMethod(name);
            }
