...
namespace KJFramework.Net.Transaction.Schedulers
{
    ...
    ///     请求分发器元接口，提供了相关的基本操作
    /// </summary>
    public interface INewRequestScheduler<TMessage>
    {
        #region Methods.
        ...
        /// <exception cref="ArgumentNullException">参数不能为空</exception>
        INewRequestScheduler<TMessage> Regist(Protocols protocol, IMessageTransactionProcessor<MetadataMessageTransaction, MetadataContainer> processor);
