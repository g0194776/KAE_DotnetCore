...
namespace KJFramework.Net.Transaction.Pools
{
    ...
    internal abstract class ConnectionSet<T>
    {
        ...
        protected int _usedBackendThread;
        ...
        /// </summary>
        public bool HasConnectionLive => _connections.Count > 0;
        ...
        protected virtual bool MakeSureConnections()
        {
            ...
            lock (_lockObj)
            {
                ...
                {
                    if (_connections.Count < _max && Interlocked.CompareExchange(ref _usedBackendThread, 1, 0) == 0) CreateAgentAsync();
                }
            }
        }
