...
namespace KJFramework.Net.Transaction.Agent
{
    ...
    public class MetadataConnectionAgent : IServerConnectionAgent<MetadataContainer>
    {
        ...
        ///     获取事务管理器
        /// </summary>
        public MetadataTransactionManager TransactionManager => _transactionManager;
        ...
        {
            if (iep == null) throw new ArgumentNullException(nameof(iep));
            if (protocolStack == null) throw new ArgumentNullException(nameof(protocolStack));
            if (transactionManager == null) throw new ArgumentNullException(nameof(transactionManager));
