...
namespace KJFramework.Net.Pool
{
    ...
    public class SocketAsyncEventArgsPool
    {
        ...
        protected void Initialize()
        {
            ...
            FieldInfo fieldInfo = typeof(SocketAsyncEventArgs).GetTypeInfo().GetField("m_CurrentSocket", BindingFlags.Instance | BindingFlags.NonPublic);
        ...
        public SocketAsyncEventArgs Rent()
        {
            if (!_args.IsEmpty)
            {
                ...
                if(_args.TryDequeue(out args)) return args;
