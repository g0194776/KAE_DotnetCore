...
namespace KJFramework.ApplicationEngine.Helpers
{
    public sealed class Crc32
    {
      ...
      755167117U
        ...
        {
            return Crc32.CrcTable[(uint)(((int)oldCrc ^ (int)value) & (int)byte.MaxValue)] ^ oldCrc >> 8;
        }
        ...
        public void Update(byte[] buffer, int offset, int count)
        {
            ...
            this.crc ^= Crc32.CrcSeed;
            while (--count >= 0)
                this.crc = Crc32.CrcTable[(uint)(((int)this.crc ^ (int)buffer[offset++]) & (int)byte.MaxValue)] ^ this.crc >> 8;
            this.crc ^= Crc32.CrcSeed;
        }
    }
}