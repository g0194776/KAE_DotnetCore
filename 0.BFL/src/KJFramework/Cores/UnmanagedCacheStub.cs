...
namespace KJFramework.Cores
{
    ...
    internal class UnmanagedCacheStub : IUnmanagedCacheStub, IUnmanagedCacheSlot
    {
        ...
        ///     获取内存句柄
        /// </summary>
        IntPtr IUnmanagedCacheStub.Handle => _innerCache.Handle;
        /// <summary>
        ...
        ///     获取当前内部的缓存使用量
        /// </summary>
        public int CurrentSize => _innerCache.UsageSize;
        /// <summary>
        ///     获取当前缓存的最大容量
        /// </summary>
        public int MaxSize => _innerCache.MaxSize;
        /// <summary>
        ///     获取内存句柄
        /// </summary>
        IntPtr IUnmanagedCacheSlot.Handle => _innerCache.Handle;
        ...
        ///     获取缓存数据
        /// </summary>
        /// <exception cref="LeaseDeadException">租约已到期</exception>
        ...
        public byte[] GetValue()
        {
            if (_lease.IsDead)
            {
                //lazy clear.
                _innerCache.Free();
                throw new LeaseDeadException("Cannot get value from a dead cache stub.");
            }
        ...
        public void SetValue(byte[] data)
        {
            if (_lease.IsDead)
            {
                //lazy clear.
                _innerCache.Free();
                throw new LeaseDeadException("Cannot set value to a dead cache stub.");
            }
